...
CREATE TABLE pais (
pais_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Pais',
...
pais_usuario_crea int(11) COMMENT 'Auditoria',
pais_fecha_crea datetime COMMENT 'Auditoria',
pais_usuario_modifica int(11) COMMENT 'Auditoria',
...
departamento_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Departamento',
departamento_nombre varchar(100) COMMENT 'Nombre',
departamento_pais_id int(11) COMMENT 'Llave primaria - pais',
departamento_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
departamento_usuario_crea int(11) COMMENT 'Auditoria',
departamento_fecha_crea datetime COMMENT 'Auditoria',
departamento_usuario_modifica int(11) COMMENT 'Auditoria',
...
municipio_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Municipio',
municipio_nombre varchar(100) COMMENT 'Nombre',
municipio_departamento_id int(11) COMMENT 'Llave primaria - departamento',
municipio_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
municipio_usuario_crea int(11) COMMENT 'Auditoria',
municipio_fecha_crea datetime COMMENT 'Auditoria',
municipio_usuario_modifica int(11) COMMENT 'Auditoria',
...
CREATE TABLE ciudad (
ciudad_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Ciudad',
ciudad_nombre varchar(100) COMMENT 'Nombre',
ciudad_municipio_id int(11) COMMENT 'Llave primaria - municipio',
ciudad_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
ciudad_usuario_crea int(11) COMMENT 'Auditoria',
ciudad_fecha_crea datetime COMMENT 'Auditoria',
ciudad_usuario_modifica int(11) COMMENT 'Auditoria',
...
CREATE TABLE genero (
genero_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Genero',
...
genero_usuario_crea int(11) COMMENT 'Auditoria',
genero_fecha_crea datetime COMMENT 'Auditoria',
genero_usuario_modifica int(11) COMMENT 'Auditoria',
...
CREATE TABLE civil (
estado_civil_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - estado civil',
...
estado_civil_usuario_crea int(11) COMMENT 'Auditoria',
estado_civil_fecha_crea datetime COMMENT 'Auditoria',
estado_civil_usuario_modifica int(11) COMMENT 'Auditoria',
...
CREATE TABLE idioma (
idioma_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - idioma',
...
idioma_usuario_crea int(11) COMMENT 'Auditoria',
idioma_fecha_crea datetime COMMENT 'Auditoria',
idioma_usuario_modifica int(11) COMMENT 'Auditoria',
...
parentesco_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - parentesco',
parentesco_nombre varchar(100) COMMENT 'Nombre',
parentesco_estado int(11) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (-1= Eliminado, 0=inactivo, 1=activo)',
parentesco_usuario_crea int(11) COMMENT 'Auditoria',
parentesco_fecha_crea datetime COMMENT 'Auditoria',
parentesco_usuario_modifica int(11) COMMENT 'Auditoria',
...
profesion_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - profesion',
...
profesion_usuario_crea int(11) COMMENT 'Auditoria',
profesion_fecha_crea datetime COMMENT 'Auditoria',
profesion_usuario_modifica int(11) COMMENT 'Auditoria',
...
persona_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Persona',
...
persona_fecha_nac date COMMENT 'Fecha de nacimiento',
...
persona_dui varchar(100) COMMENT 'Dui',
persona_nit varchar(100) COMMENT 'nit',
persona_observaciones varchar(300) COMMENT 'Dui',
persona_genero_id int(11) COMMENT 'Llave primaria - Genero',
persona_estado_civil_id int(11) COMMENT 'Llave primaria - estado civil',
persona_profesion_id int(11) COMMENT 'Llave primaria - profesion',
persona_tipo int(11) NOT NULL DEFAULT 1 COMMENT '(0=contratado, 1=temporal, 2=outsourcing, 3=facilitador, 4=externo, 5=proveedor, 6=cliente)',
persona_municipio_id int(11) COMMENT 'Llave primaria - municipio',
persona_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (0=inactivo, 1=activo, 2= Eliminado)',
persona_usuario_crea int(11) COMMENT 'Auditoria',
persona_fecha_crea datetime COMMENT 'Auditoria',
persona_usuario_modifica int(11) COMMENT 'Auditoria',
...
experiencia_laboral_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Experiencia Laboral',
experiencia_laboral_empresa varchar(100) COMMENT 'Empresa',
experiencia_laboral_cargo varchar(100) COMMENT 'Cargo',
experiencia_laboral_anio int(11) COMMENT 'Anios de experiencia',
experiencia_laboral_fecha_desde date COMMENT 'Fecha desde',
...
experiencia_laboral_persona_id int(11) COMMENT 'Llave primaria - Persona',
experiencia_laboral_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
experiencia_laboral_usuario_crea int(11) COMMENT 'Auditoria',
experiencia_laboral_fecha_crea datetime COMMENT 'Auditoria',
experiencia_laboral_usuario_modifica int(11) COMMENT 'Auditoria',
...
habilidades_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - Habilidades',
...
habilidades_persona_id int(11) COMMENT 'Llave primaria - Persona',
habilidades_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
habilidades_usuario_crea int(11) COMMENT 'Auditoria',
habilidades_fecha_crea datetime COMMENT 'Auditoria',
habilidades_usuario_modifica int(11) COMMENT 'Auditoria',
...
contactos_id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave  primaria - contactos',
...
contactos_persona_id int(11) COMMENT 'Llave primaria - Persona',
contactos_parentesco_id int(11) COMMENT 'Llave primaria - Parentesco',
contactos_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
contactos_usuario_crea int(11) COMMENT 'Auditoria',
contactos_fecha_crea datetime COMMENT 'Auditoria',
contactos_usuario_modifica int(11) COMMENT 'Auditoria',
...
accesos_id int (11) NOT NULL AUTO_INCREMENT ,
accesos_nombre int(11) NOT NULL,
accesos_descripcion int(11),
...
accesos_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
accesos_fecha_crea datetime comment 'fecha de creacion del registro',
accesos_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
roles_nombre int(11) NOT NULL,
roles_descripcion int(11),
roles_llave0 int(11),
...
roles_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
roles_fecha_crea datetime comment 'fecha de creacion del registro',
roles_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
usuarios_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
usuarios_fecha_crea datetime comment 'fecha de creacion del registro',
usuarios_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
estados_id_usuario_crea varchar (10) comment 'id del usuario que creo el estado',
estados_fecha_crea datetime comment 'fecha de creacion del estado',
estados_id_usuario_modi varchar (10) comment 'id del usuario que modifico el estado',
...
agencias_id int(11) NOT NULL AUTO_INCREMENT ,
...
municipio_id int(11),
ciudad_id int(11),
agencia_usuario_id int(11) comment 'Usuario encargado de la agencia',
agencia_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
agencia_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
agencia_fecha_crea datetime comment 'fecha de creacion del registro',
agencia_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
tipo_activo_id int(11) NOT NULL AUTO_INCREMENT ,
...
tipo_activo_cantidad_tiempo int(9),
tipo_activo_tiempo_id int(11) COMMENT 'Factor por el cual se efectuara la medicion de la vida util o depreciacion',
tipo_activo_porcentaje int(9) COMMENT 'Porcentaje sobre valor por escala de tiempo',
tipo_activo_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
tipo_activo_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
tipo_activo_fecha_crea datetime comment 'fecha de creacion del registro',
tipo_activo_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
tiempo_id int(11) NOT NULL AUTO_INCREMENT ,
...
tiempo_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
tiempo_fecha_crea datetime comment 'fecha de creacion del registro',
tiempo_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
periodos_id int(11) NOT NULL AUTO_INCREMENT,
...
periodos_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
periodos_fecha_crea datetime comment 'fecha de creacion del registro',
periodos_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
transaccion_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
transaccion_fecha_crea datetime comment 'fecha de creacion del registro',
transaccion_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
inventario_agencia_id int(11) NOT NULL COMMENT 'Agencia en donde se encuentra fisicamente el activo',
inventario_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo)',
inventario_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
inventario_fecha_crea datetime comment 'fecha de creacion del registro',
inventario_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
mantenimientos_id int(11) NOT NULL AUTO_INCREMENT,
...
mantenimientos_monto_final int(11) NOT NULL COMMENT 'Monto por el cual se esta efectuando el mantenimiento',
...
mantenimientos_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
mantenimientos_fecha_crea datetime comment 'fecha de creacion del registro',
mantenimientos_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
depreciacion_monto_inicial int(11) NOT NULL,
depreciacion_monto_depreciado int(11) NOT null,
depreciacion_monto_restante int(11) NOT NULL,
depreciacion_correlativo int(11) NOT NULL,
depreciacion_control int(11) NOT NULL,
depreciacion_estado int(1) NOT NULL DEFAULT 1 COMMENT 'Estado de registro (2= Eliminado, 0=inactivo, 1=activo',
depreciacion_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
depreciacion_fecha_crea datetime comment 'fecha de creacion del registro',
depreciacion_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
...
CREATE TABLE bienes (
bienes_id int(11) NOT NULL AUTO_INCREMENT ,
tipo_activo_id int(11) NOT NULL,
bienes_codigo int(11) NOT NULL,
...
bienes_monto_compra int (11),
bienes_fecha_venta datetime ,
bienes_monto_venta int (11),
...
bienes_id_usuario_crea varchar (10) comment 'id del usuario que creo el registro',
bienes_fecha_crea datetime comment 'fecha de creacion del registro',
bienes_id_usuario_modi varchar (10) comment 'id del usuario que modifico el registro',
